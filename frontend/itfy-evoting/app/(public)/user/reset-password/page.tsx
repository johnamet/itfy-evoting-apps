 ...
 * Route: /user/reset-password?token=xxx
 * 
 * This page handles password reset requests from email links.
 * The token is validated with the backend API before allowing password reset.
 */
  ...
  const onSubmit = async (data: ResetPasswordFormData) => {
    ...
    if (result.success) {
      ...
      toast.error('Reset failed', {
        description: result.error || 'The reset link may be invalid or expired. Please request a new one.',
      });
    }
  };
