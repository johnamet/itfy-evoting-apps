...
var FILE_SIZE_LIMITS = exports.FILE_SIZE_LIMITS = {
  ...
  LOGO: 2,
  // 2MB for event/category logos
  DOCUMENT: 10,
  // 10MB for general documents
  IMAGE: 5,
  // 5MB for general images
  CANDIDATE_PHOTO: 5,
  // 5MB for candidate photos
...
var ALLOWED_FILE_TYPES = exports.ALLOWED_FILE_TYPES = {
  ...
  ALL: ["image/jpeg", "image/jpg", "image/png", "image/webp", "image/gif", "application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"]
};
