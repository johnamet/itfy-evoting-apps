...
import { helmetConfig, createCorsConfig, sanitizeInput, validateContentType, blockSuspiciousPatterns, additionalSecurityHeaders } from "./middleware/security.middleware.js";
import { requestContextMiddleware, clientIPMiddleware } from "./middleware/request-context.middleware.js";
...
app.use((req, res, next) => {
  ...
  httpLogFormat.stream.write(`${req.method} ${req.path} ${res.statusCode} - ${req.clientIP}`);
  next();
});
