...
export const couponQuerySchema = Joi.object({
  ...
  sort: Joi.string().valid("code", "discount_value", "current_redemptions", "validity_end", "created_at", "-code", "-discount_value", "-current_redemptions", "-validity_end", "-created_at").default("-created_at")
});
