 ...
 */
var Coupon = /*#__PURE__*/function (_BaseModel) {
  function Coupon() {
    var _this;
    ...
    var schemaDefinition = {
      ...
      discount_type: {
        type: String,
        required: true,
        "enum": Object.values(_voteConstants.DISCOUNT_TYPE)
      },
      discount_value: {
        type: Number,
        required: true,
      ...
      status: {
        type: String,
        "enum": Object.values(_voteConstants.COUPON_STATUS),
        "default": _voteConstants.COUPON_STATUS.ACTIVE,
        index: true
      },
      max_total_uses: {
        type: Number,
    ...
    _this = _callSuper(this, Coupon, [schemaDefinition, options]);
    ...
    _this.schema.pre("save", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(next) {
        var Bundle, bundles, _iterator, _step, bundle, _t, _t2;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 1:
              if (!(this.discount_type === _voteConstants.DISCOUNT_TYPE.PERCENTAGE)) {
                _context.n = 2;
                break;
              }
            ...
            case 2:
              ...
              Bundle = _mongoose["default"].model("Bundle");
              _context.n = 3;
              return Bundle.find({
                _id: {
                  $in: this.applicable_bundles
                }
              });
            case 3:
              bundles = _context.v;
            ...
            case 10:
              ...
              if (this.max_total_uses && this.current_redemptions >= this.max_total_uses) {
                this.status = _voteConstants.COUPON_STATUS.EXPIRED;
              }
              next();
              _context.n = 12;
              break;
    ...
    _this.schema.virtual("isValid").get(function () {
      if (this.status !== _voteConstants.COUPON_STATUS.ACTIVE) return false;
      var now = new Date();
    ...
    _this.schema.virtual("isExpired").get(function () {
      if (this.status === _voteConstants.COUPON_STATUS.EXPIRED) return true;
      var now = new Date();
    ...
    _this.schema.virtual("isPercentageDiscount").get(function () {
      return this.discount_type === _voteConstants.DISCOUNT_TYPE.PERCENTAGE;
    });

    // Virtual: Is fixed discount
    _this.schema.virtual("isFixedDiscount").get(function () {
      return this.discount_type === _voteConstants.DISCOUNT_TYPE.FIXED_AMOUNT;
    });

    // Virtual: Is bonus votes
    _this.schema.virtual("isBonusVotes").get(function () {
      return this.discount_type === _voteConstants.DISCOUNT_TYPE.BONUS_VOTES;
    });
    ...
    _this.schema.statics.findActiveByEvent = /*#__PURE__*/function () {
    ...
    _this.schema.statics.findPublic = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
      var eventId,
        options,
        filter,
        query,
    ...
    _this.schema.statics.findByCode = /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(code) {
        var options,
          query,
          _args5 = arguments;
    ...
    _this.schema.methods.validateForBundle = function (bundleId, bundlePrice) {
      ...
      if (this.applicable_bundles && this.applicable_bundles.length > 0) {
        var applies = this.applicable_bundles.some(function (bid) {
          return bid.toString() === bundleId.toString();
        });
        if (!applies) {
          return {
            valid: false,
            message: "Coupon does not apply to this bundle"
          };
        }
      }
      ...
      if (this.min_purchase_amount > 0 && bundlePrice < this.min_purchase_amount) {
        return {
          valid: false,
          message: "Minimum purchase amount of ".concat(this.min_purchase_amount, " required")
        };
      }
      return {
        valid: true,
    ...
    _this.schema.methods.calculateDiscount = function (bundlePrice, bundleVotes) {
      var discountAmount = 0;
      var bonusVotes = 0;
      var finalPrice = bundlePrice;
      var finalVotes = bundleVotes;
      switch (this.discount_type) {
        case _voteConstants.DISCOUNT_TYPE.PERCENTAGE:
          ...
          break;
        case _voteConstants.DISCOUNT_TYPE.FIXED_AMOUNT:
          discountAmount = Math.min(this.discount_value, bundlePrice);
          finalPrice = bundlePrice - discountAmount;
          break;
        case _voteConstants.DISCOUNT_TYPE.BONUS_VOTES:
          bonusVotes = this.discount_value;
          finalVotes = bundleVotes + bonusVotes;
          break;
        case _voteConstants.DISCOUNT_TYPE.FREE_BUNDLE:
    ...
    _this.schema.methods.redeem = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
    ...
    _this.schema.methods.canUserRedeem = /*#__PURE__*/function () {
      var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(userIdentifier) {
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.n) {
            case 0:
              return _context8.a(2, this.current_redemptions < (this.max_total_uses || Infinity));
          }
        }, _callee8, this);
      }));
      return function (_x5) {
...
var _default = exports["default"] = new Coupon().getModel("Coupon");