...
class CouponController extends BaseController {
  ...
  async list(req, res) {
    ...
    const result = await this.service("couponService").repository.findAll(filters, page, limit, {
      sort
    });
  ...
  async validateCoupon(req, res) {
    ...
    const result = await this.service("couponService").validateCouponForBundle(validated.code, validated.bundle_id, userEmail);
    return this.success(res, {
      data: result
    });
  }
  ...
  async applyCoupon(req, res) {
    ...
    const validationResult = await this.service("couponService").validateCouponForBundle(validated.code, validated.bundle_id, userEmail);
