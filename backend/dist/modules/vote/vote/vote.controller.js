...
class VoteController extends BaseController {
  ...
  async list(req, res) {
    ...
    const result = await this.service("voteService").repository.findAll(filters, page, limit, {
      sort,
  ...
  async getVotingTrends(req, res) {
    ...
    const trends = await this.service("voteService").getVotingTrends(eventId, interval || "day", start_date ? new Date(start_date) : undefined, end_date ? new Date(end_date) : undefined);
    return this.success(res, {
      data: trends
    });
  }
  ...
  async detectSuspicious(req, res) {
    ...
    const patterns = await this.service("voteService").detectSuspiciousPatterns(eventId, threshold, minutes);
    return this.success(res, {
      data: patterns
    });
  }
