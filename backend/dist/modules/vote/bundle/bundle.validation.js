...
export const bundleQuerySchema = Joi.object({
  ...
  sort: Joi.string().valid("name", "price", "vote_count", "total_purchases", "display_order", "created_at", "-name", "-price", "-vote_count", "-total_purchases", "-display_order", "-created_at").default("display_order")
});
