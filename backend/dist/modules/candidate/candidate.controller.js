...
class CandidateController extends BaseController {
  ...
  async listPublic(req, res) {
    ...
    const [candidates, total] = await Promise.all([this.service("candidateService").findAll(filters, {
      skip,
      limit,
      sort
  ...
  async bulkReject(req, res) {
    ...
    const adminId = this.getUserId(req);
    const result = await this.service("candidateService").bulkReject(validated.candidateIds, validated.reason, adminId);
    return this.success(res, {
      data: result,
  ...
  async getPublicByEvent(req, res) {
    ...
    const [candidates, total] = await Promise.all([this.service("candidateService").getPublicCandidates(eventId, categoryId, {
      skip,
      limit
