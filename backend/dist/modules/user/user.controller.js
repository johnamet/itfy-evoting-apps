...
class UserController extends BaseController {
  ...
  async list(req, res) {
    ...
    const [users, total] = await Promise.all([this.service("userService").findAll(filters, {
      skip,
      limit,
      sort
  ...
  async bulkUpdateStatus(req, res) {
    ...
    const adminId = this.getUserId(req);
    const result = await this.service("userService").bulkUpdateStatus(validated.userIds, validated.status, adminId);
    return this.success(res, {
      data: result,
  ...
  */
  ...
  async bulkAction(req, res) {
    ...
    const adminId = this.getUserId(req);
    const result = await this.service("userService").bulkAction(validated.userIds, validated.action, adminId, validated.reason);
    return this.success(res, {
      data: result,
  ...
  async bulkDelete(req, res) {
    ...
    const adminId = this.getUserId(req);
    const result = await this.service("userService").bulkDelete(validated.userIds, adminId);
    return this.success(res, {
      data: result,
  ...
  async bulkRestore(req, res) {
    ...
    const result = await this.service("userService").bulkRestore(validated.userIds, adminId);
    return this.success(res, {
      data: result,
  ...
  async searchUsers(req, res) {
    ...
    const result = await this.service("userService").advancedSearch(validated.searchTerm, validated.filters);
    return this.success(res, {
      data: result
    });
  }
  ...
  async getUserActivity(req, res) {
    ...
    const activities = await this.service("activityService").getUserActivities(id, {
      skip,
      limit
    });
    return this.paginated(res, {
