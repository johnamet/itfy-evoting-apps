...
class UserValidation {
  ...
  static bulkActionSchema = Joi.object({
    ...
    action: Joi.string().valid("activate", "deactivate", "suspend", "delete", "verify_email").required().messages({
  ...
  static userQuerySchema = Joi.object({
    ...
    sort: Joi.string().valid("name", "email", "created_at", "last_login", "-name", "-email", "-created_at", "-last_login").default("-created_at").messages({
