...
class SubmissionController extends BaseController {
  ...
  async list(req, res) {
    ...
    const result = await this.service("submissionService").repository.findAll(filters, page, limit, {
      sort,
  ...
  async reject(req, res) {
    ...
    const adminId = this.getUserId(req);
    const submission = await this.service("submissionService").rejectSubmission(id, adminId, validated.rejection_reason);
    return this.success(res, {
      data: submission,
