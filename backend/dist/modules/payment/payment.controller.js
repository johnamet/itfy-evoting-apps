...
class PaymentController extends BaseController {
  ...
  async list(req, res) {
    ...
    const filters = this.getFilters(req, ["event", "bundle", "payment_status", "payment_method", "voter_email", "vote_code", "transaction_reference", "webhook_received"]);
    ...
    const result = await this.service("paymentService").repository.findAll(filters, page, limit, {
      sort,
  ...
  async getDailyRevenue(req, res) {
    ...
    const revenue = await this.service("paymentService").getDailyRevenue(eventId, start_date ? new Date(start_date) : undefined, end_date ? new Date(end_date) : undefined);
    return this.success(res, {
      data: revenue
    });
  }
