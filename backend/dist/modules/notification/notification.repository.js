...
import { NOTIFICATION_STATUS, NOTIFICATION_CHANNEL, NOTIFICATION_PRIORITY, NOTIFICATION_TYPE } from "../../utils/constants/notification.constants.js";
class NotificationRepository extends BaseRepository {
  ...
  async findByChannel(channel, status = null, limit = 100, options = {}) {
    try {
      ...
      const queryBuilder = this.model.find(query).sort({
        created_at: -1
      }).limit(limit);
