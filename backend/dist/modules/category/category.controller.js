...
class CategoryController extends BaseController {
  ...
  */
  async listPublic(req, res) {
    ...
    const [categories, total] = await Promise.all([this.service("categoryService").findAll(filters, {
      skip,
      limit,
      sort
  ...
  async updateDeadline(req, res) {
    ...
    const adminId = this.getUserId(req);
    const category = await this.service("categoryService").updateVotingDeadline(id, validated.voting_deadline, adminId);
    return this.success(res, {
      data: category,
  ...
  async extendDeadline(req, res) {
    ...
    const adminId = this.getUserId(req);
    const category = await this.service("categoryService").extendVotingDeadline(id, validated.hours, adminId);
    return this.success(res, {
      data: category,
  ...
  async getCandidates(req, res) {
    ...
    const [candidates, total] = await Promise.all([this.service("categoryService").getCategoryCandidates(id, {
      skip,
      limit,
      sort
  ...
  async addCandidates(req, res) {
    ...
    const adminId = this.getUserId(req);
    const category = await this.service("categoryService").addCandidates(id, validated.candidateIds, adminId);
    return this.success(res, {
      data: category,
  ...
  async removeCandidates(req, res) {
    ...
    const adminId = this.getUserId(req);
    const category = await this.service("categoryService").removeCandidates(id, validated.candidateIds, adminId);
    return this.success(res, {
      data: category,
  ...
  async updateOrder(req, res) {
    ...
    const adminId = this.getUserId(req);
    const category = await this.service("categoryService").updateDisplayOrder(id, validated.display_order, adminId);
    return this.success(res, {
      data: category,
