...
export const categoryQuerySchema = Joi.object({
  ...
  sort: Joi.string().valid("name", "display_order", "total_votes", "voting_deadline", "created_at", "-name", "-display_order", "-total_votes", "-voting_deadline", "-created_at").default("display_order")
});
