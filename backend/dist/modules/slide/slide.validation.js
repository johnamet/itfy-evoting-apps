...
export const slideQuerySchema = Joi.object({
  ...
  sort: Joi.string().valid("display_order", "title", "view_count", "click_count", "created_at", "-display_order", "-title", "-view_count", "-click_count", "-created_at").default("display_order")
});
...
export const reorderSlidesSchema = Joi.object({
  slide_orders: Joi.array().items(Joi.object({
    id: ObjectId().required(),
