...
const ghanaianFirstNames = ["Kwame", "Kofi", "Kwesi", "Yaw", "Kwabena", "Kojo", "Kwaku", "Akosua", "Ama", "Abena", "Adjoa", "Akua", "Yaa", "Afia", "Nana", "Adwoa", "Efua", "Araba", "Ekua", "Esi", "Afua", "Kwadwo", "Kwasi", "Papa", "Kobby", "Obeng", "Mensah", "Nii"];
const ghanaianLastNames = ["Asante", "Osei", "Mensah", "Boateng", "Agyeman", "Annan", "Owusu", "Adjei", "Amoah", "Appiah", "Asare", "Baidoo", "Darko", "Donkor", "Frimpong", "Gyamfi", "Kusi", "Nkrumah", "Oppong", "Quaye", "Sarpong", "Tetteh", "Yeboah", "Adomako", "Addo", "Agyapong", "Amponsah", "Ansah", "Boadu", "Dankwa", "Edusei", "Fordjour", "Gyasi", "Kwafo", "Larbi"];
...
class DatabaseSeeder {
  ...
  async seedCandidates() {
    ...
    for (const category of this.categories) {
      ...
      const categoryType = event.name.includes("Music") ? "music" : event.name.includes("Miss") ? "beauty" : "tech";
  ...
  async seedCoupons() {
    ...
    const couponTemplates = [{
      ...
      code: "BONUS50",
      discount_type: DISCOUNT_TYPE.BONUS_VOTES,
      discount_value: 50,
      max_total_uses: 30,
  ...
  async seedActivities() {
    ...
    const activityTypes = [{
      ...
      action: ACTION_TYPE.EVENT_CREATE,
      entity_type: ENTITY_TYPE.EVENT,
      description: "Created event",
      severity: SEVERITY.INFO
    }, {
      action: ACTION_TYPE.CANDIDATE_APPROVE,
      entity_type: ENTITY_TYPE.CANDIDATE,
      description: "Approved candidate",
      severity: SEVERITY.INFO
    }, {
      action: ACTION_TYPE.CATEGORY_CREATE,
    ...
    for (const user of this.users) {
      for (const activity of activityTypes) {
        await activityModel.create({
          ...
          entity_id: activity.entity_type === ENTITY_TYPE.EVENT ? this.events[0]._id : activity.entity_type === ENTITY_TYPE.CANDIDATE ? this.candidates[0]?._id : activity.entity_type === ENTITY_TYPE.CATEGORY ? this.categories[0]?._id : user._id,
