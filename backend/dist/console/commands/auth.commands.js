...
export class AuthCommands {
  ...
  async login(email) {
    ...
    // Get password
    const password = await this.ui.question('Password', {
      hidden: true
    });
    if (!email || !password) {
  ...
  async changePassword() {
    const currentPassword = await this.ui.question('Current password', {
      hidden: true
    });
    ...
    while (!passwordMatch) {
      ...
      const confirmPassword = await this.ui.question('Confirm new password', {
        hidden: true
      });
