...
export const createCorsConfig = () => {
  ...
  return {
    ...
    allowedHeaders: ["Origin", "X-Requested-With", "Content-Type", "Accept", "Authorization", "X-Request-ID", "X-Correlation-ID"],
...
export const validateProductionEnvironment = () => {
  ...
  const requiredVars = ["JWT_SECRET", "JWT_REFRESH_SECRET", "MONGODB_URI", "CORS_ORIGIN"];
